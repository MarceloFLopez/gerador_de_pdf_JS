...
document.addEventListener('DOMContentLoaded', () => {
 ...
 { name: "Paulo Palhares", age: 8, address: "Avenida Hélio", number: 616 },
  ...
  { name: "Matheus Quarteira", age: 89, address: "Avenida Mateus", number: 209 },
    ...
    const medicaments = [
        { name: "Amoxicilina 400mg/5ml + Clavulanato 75ml 70ml", posology: "5ml a cada 8 horas durante 7 dias" },
        { name: "Amoxicilina 500mg 21cps ", posology: "1cp a cada 8 horas durante 7 dias" },
        { name: "Amoxicilina 875mg 14cps ", posology: "1cp a cada 12 horas durante 7 dias" },
        { name: "Amoxicilina 500mg + Clavulanato 30cps", posology: "1cp a cada 8 horas durante 7 dias" },
        { name: "Amoxicilina 875mg + Clavulanato 20cps ", posology: "1cp a cada 12 horas durante 7 dias" },
        { name: "Azitromicina 500mg 5cps ", posology: "1cp ao dia durante 5 dias" },
        { name: "Azitromicina 200ml/5ml 15ml", posology: "5ml a cada 8 horas durante 7 dias" },
        { name: "Azitromicina 200ml/5ml 22,5ml", posology: "5ml a cada 8 horas durante 7 dias" },
        { name: "Bactrin 20cps ", posology: "1cp a cada 12 horas durante 7 dias" },
        { name: "Bactrin F 20cps ", posology: "1cp a cada 12 horas durante 7 dias" },
        { name: "Bactrin suspens ", posology: "5ml a cada 12 horas durante 7 dias" },
        { name: "Bactrin F suspens ", posology: "5ml a cada 12 horas durante 7 dias" },
        { name: "Cefalexina 500mg 28cps ", posology: "1cp a cada 6 horas durante 7 dias" },
        { name: "Cefalexina 200ml/5ml 15ml", posology: "5ml a cada 8 horas durante 7 dias" },	
	{ name: "Ciprofloxacino 500mg 14cp ", posology: "1cp a cada 12 horas durante 7 dias" },
	{ name: "Claritromicina 500mg 10cps ", posology: "1cp a cada 12 horas durante 5 dias" },	
	{ name: "Clindamicina 300mg 16cp ", posology: "1cp a cada 12 horas durante 7 dias" },
	{ name: "Levofloxacino 500mg 7cp ", posology: "1cp ao dia durante 7 dias" },
	{ name: "Levofloxacino 750mg 7cp ", posology: "1cp ao dia durante 7 dias" },
	{ name: "Benzoilmetronidazol 40mg/ml 120ml ", posology: "5ml a cada 12 horas durante 7 dias" },
	{ name: "Metronidazol 250mg 14cp ", posology: "1cp a cada 12 horas durante 7 dias" },
	{ name: "Metronidazol 400mg 14cp ", posology: "1cp a cada 12 horas durante 7 dias" },
	{ name: "Metronidazol Gel Vaginal ", posology: "1 aplicador a noite durante 7 noites" },
	{ name: "Metronidazol + Nistatina Gel Vaginal", posology: "1 aplicador a noite durante 7 noites" },
	{ name: "Norfloxacino 500mg 14cp ", posology: "1cp a cada 12 horas durante 7 dias" },
        { name: "Dipirona gotas", posology: "25 gotas a cada 6 horas se dor ou febre" }, // Medicamento estático 1
        { name: "Expec Xarope", posology: "5ml a cada 6 horas durante 4 dias" }, // Medicamento estático 2
...
patients.forEach((patient, index) => {
    ...
    window.generatePDF = () => {
        ...
        doc.setFontSize(16); // Ajusta o tamanho da fonte do título
        const medTitle = 'Prescrição de Medicamentos';
        ...
        const medicament3Name = "Expec Xarope";
        const medicament3Posology = "5ml a cada 6 horas durante 4 dias";
